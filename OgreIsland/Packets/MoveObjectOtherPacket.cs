...
{
    public class MoveObjectOtherPacket : AbstractPacket
    {
        public MoveObjectOtherPacket() : base(new Packet("MOVEOBJ2", new string[4])) { }
        public MoveObjectOtherPacket(Packet packet) : base(packet) { }
